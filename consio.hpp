...
void InitConsoleOptions(MESSAGE_TYPE MsgStream,bool Sound);
  ...
  bool GetPassword(PASSWORD_TYPE Type,const char *FileName,char *Password,uint MaxLength);
#endif
...
void OutComment(char *Comment,size_t Size);
  ...
  inline bool GetPassword(PASSWORD_TYPE Type,const char *FileName,char *Password,uint MaxLength) {return(false);}
#endif
